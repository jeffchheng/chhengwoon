    ...
    <div>
      ...
      <PageWrapper>
        ...
        <SectionText>
          ...
          to find and compare the cheapest airfare. We generally fly Alaska Airlines. 
        </SectionText>

        <SectionHeader>Traveling to Downtown Seattle</SectionHeader>

        <SectionText>
          When leaving the airport, there are several travel options to get to downtown Seattle: rideshare (like Lyft and Uber), taxi, and the Link. After baggage claim, follow the marked signs to go up the escalator and across the skybridge to the 4th floor of the airport parking garage. 
          </SectionText>
          
          <SectionText>If you use a{" "}
          <OutsideLink href="https://www.portseattle.org/sea-tac/ground-transportation/app-based-rideshare">
            rideshare app
          </OutsideLink>
          , there are designated pick-up spots on the 3rd floor of the airport parking garage.</SectionText>

          <SectionText>There are also{" "}
          <OutsideLink href="https://www.portseattle.org/sea-tac/ground-transportation/taxis">
            taxis
          </OutsideLink>{" "}
           located on the 3rd floor of the airport parking garage.</SectionText>

           <SectionText>For the most affordable option, you can follow signs to the{" "}
          <OutsideLink href="https://www.soundtransit.org/ride-with-us/popular-destinations/sea-tac-airport">
            Link Light Rail
          </OutsideLink>
          . You can either walk along the corridor (~2-3 blocks in length) or look for the free courtesy shuttle to transport you from the airport parking garage to the Link station. Link trains run every 6, 10 or 15 minutes depending on the time of
          day. Service is available from 5 am to 1 am. Monday through
          Saturday, and from 6 am to midnight on Sunday and holidays. There are ticket vending machines located on the floor below the platform. Adult fares range from $2.25 to $3.25 depending on how far you travel. The
        ...
        <SectionText>
         We recommend staying at the Arctic Club itself! Make
        ...
        <SectionText>
          ...
          distance of the Arctic Club. We recommend staying at locations north of Cherry Street. Some suggestions:
          
        </SectionText>

        <ul className="list-disc list-outside px-10">
        <li>
          <OutsideLink href="http://www.innatthemarket.com/">Inn at the Market</OutsideLink> (in the heart of Pike Place Market)
          </li>
        <li>
        <OutsideLink href="https://www.palladianhotel.com/">Kimpton Palladian</OutsideLink> 
        </li>
        <li>
        <OutsideLink href="https://www.thompsonhotels.com/hotels/washington/seattle/thompson-seattle">Thompson Seattle</OutsideLink> 
        </li>
        <li>
        <OutsideLink href="https://www.fairmont.com/seattle/">Fairmont Olympic</OutsideLink> 
        </li>
        </ul>
